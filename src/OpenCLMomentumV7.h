...
#ifndef __momentumCL__OpenCLMomentumV7__
#define __momentumCL__OpenCLMomentumV7__
...
class OpenCLMomentumV7: public AbstractMomentum {
public:
	OpenCLMomentumV7(int _HASH_BITS, int device_num);
	virtual ~OpenCLMomentumV7();
...
#endif /* defined(__momentumCL__OpenCLMomentumV7__) */
