...
#ifndef __momentumCL__OpenCLMomentumV8__
#define __momentumCL__OpenCLMomentumV8__
...
class OpenCLMomentumV8: public AbstractMomentum {
public:
	OpenCLMomentumV8(int _HASH_BITS, int device_num);
	virtual ~OpenCLMomentumV8();
...
#endif /* defined(__momentumCL__OpenCLMomentumV8__) */
